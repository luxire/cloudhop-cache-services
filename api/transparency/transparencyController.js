...
client.on('connect', function(){
  console.log('Connected to redis server  in api / transparency / transparency.controller.js');
})


exports.index = function(req,res){
  console.log("calling transparency index functionality...");
    console.log("request params :",req.query);
    var demoTransparency = req.query.transparency.toLowerCase();
    client.hvals("productsTransparencyIndex:"+demoTransparency, function(err, result){
      if(err){
        console.log("getting error creating products weave type  index: ",err);
      }
      if(result){
        console.log("product ids for weave type : "+demoTransparency+"  are as follows\n");
        var productsArr = [];
