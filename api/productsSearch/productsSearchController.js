...
exports.deleteProductInRedisById = function(req, res ){
  console.log("calling function delete product in redis by id...");
  ...
  promiseObj.then(function(result){
    ...
    client.get("products:"+product_id, function(err,reply){
                    ...
                    if(mainProductColor[x].indexOf(baseColor[y]) != -1){
                      ...
                      client.hdel("product:"+productType+":"+productVariant+":product_color:index:"+propertyName, "product:"+storedProductObj.id, function(err, reply){
                        ...
                        if(reply){
                          ...
                          console.log("product_color index is deleted sucessfully...");
                        }
                      });
      ...
      res.json({"msg": "INDEXING RELATED TO THIS PRODUCT IS DELETED SUCESSFULLY.."});
